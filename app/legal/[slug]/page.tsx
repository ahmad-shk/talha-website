        ...
        <article>
          ...
          {d[1].map((h: string, i: number) => (
            <section key={h}>
              ...
              <p>
                This replica provides a representative legal-information layout.
                Production legal text should be supplied by the site owner and
                reviewed by qualified counsel before publication.
              </p>
            </section>
          ))}
        </article>
