...
export default function USAOutlineBackground() {
  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 top-[8%] z-0 flex justify-center opacity-[0.22] sm:top-[10%] sm:opacity-[0.28]" aria-hidden="true">
      <svg
        ref={svgRef}
      ...
      >
        <defs>
          ...
          <mask id="usa-glow-mask">
            ...
            <circle ref={cursorRef} cx="500" cy="280" r="116" fill="url(#usa-spotlight)" filter="url(#usa-blur-mask)" />
          </mask>
        ...
        <path d={USA_PATH} fill="none" stroke="var(--fm-border-accent)" strokeWidth="1.05" strokeLinecap="round" strokeLinejoin="round" vectorEffect="non-scaling-stroke" />
        <g ref={glowRef} mask="url(#usa-glow-mask)">
          <path d={USA_PATH} fill="none" stroke="var(--fm-lime)" strokeWidth="9" strokeLinecap="round" strokeLinejoin="round" vectorEffect="non-scaling-stroke" filter="url(#usa-blur-wide)" />
          <path d={USA_PATH} fill="none" stroke="var(--fm-lime-bright)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" vectorEffect="non-scaling-stroke" filter="url(#usa-blur-tight)" />
        </g>
      </svg>
    </div>
  );
