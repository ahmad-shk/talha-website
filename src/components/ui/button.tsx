...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center border text-sm font-medium whitespace-nowrap transition-[transform,background-color,border-color,color,box-shadow] duration-[var(--fm-motion-component)] ease-[var(--fm-motion-ease)] outline-none select-none focus-visible:border-[var(--fm-lime)] focus-visible:ring-3 focus-visible:ring-[var(--fm-lime-soft)] active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: 'rounded-[var(--fm-radius-pill)] border-[var(--fm-lime)] bg-[var(--fm-lime)] text-[var(--fm-graphite-deep)] hover:border-[var(--fm-lime-bright)] hover:bg-[var(--fm-lime-bright)]',
        outline: 'rounded-[var(--fm-radius-pill)] border-[var(--fm-border)] bg-[var(--fm-surface)] text-[var(--fm-text-primary)] hover:border-[var(--fm-border-accent)] hover:bg-[var(--fm-surface-raised)]',
        secondary: 'rounded-[var(--fm-radius-pill)] border-[var(--fm-border)] bg-[var(--fm-surface-raised)] text-[var(--fm-text-primary)] hover:border-[var(--fm-border-accent)] hover:bg-[var(--fm-surface)]',
        ghost: 'rounded-[var(--fm-radius-md)] border-transparent text-[var(--fm-text-secondary)] hover:bg-[var(--fm-surface-raised)] hover:text-[var(--fm-text-primary)]',
        destructive: 'rounded-[var(--fm-radius-pill)] border-[var(--fm-danger)]/30 bg-[var(--fm-danger-soft)] text-[var(--fm-danger)] hover:bg-[var(--fm-danger)]/20',
...
function Button({ className, variant = 'default', size = 'default', render, asChild = false, children, ...props }: ButtonProps) {
