          ...
          {STEPS.map((step) => (
            <Card key={step.n} variant="interactive" className="p-6">
              <div className="mb-6 flex items-center gap-4">
                <span className="font-mono text-sm font-bold tracking-[.12em] text-[var(--fm-lime)]">{step.n}</span>
              </div>
              <h3 className="mb-3 font-display text-xl font-bold tracking-[-.025em] text-[var(--fm-text-primary)]">{step.title}</h3>
