    ...
    >
      ...
      <div className="relative z-[1] mx-auto max-w-[880px] text-center">
        ...
        <p className="mx-auto mt-[22px] max-w-[540px] text-lg leading-relaxed text-[var(--fm-graphite)]/75">
          Tell us your business name and your state. We&apos;ll handle everything between you and your first
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4 sm:flex-row">
          <Button
            ...
            size="lg"
            className="border-[var(--fm-graphite-deep)] bg-[var(--fm-graphite-deep)] px-9 font-extrabold text-[var(--fm-lime)] shadow-[var(--fm-shadow-elevated)] hover:border-[var(--fm-graphite)] hover:bg-[var(--fm-graphite)] hover:text-[var(--fm-lime-bright)]"
          >
            Get Started
          </Button>
          <a
            href="https://calendly.com/foremint-pk/lets-have-a-consultation-call"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex h-12 items-center justify-center rounded-[var(--fm-radius-pill)] border border-[var(--fm-graphite-deep)]/30 bg-[var(--fm-graphite-deep)]/10 px-9 text-center font-sans text-base font-bold text-[var(--fm-graphite-deep)] backdrop-blur transition-[transform,background-color,border-color] duration-[var(--fm-motion-component)] hover:-translate-y-0.5 hover:bg-[var(--fm-graphite-deep)]/15"
          >
            Talk to us
          </a>
        </div>
        <p className="mt-9 font-mono text-xs uppercase tracking-[0.12em] text-[var(--fm-graphite)]/60">
          From $119 + state fee · No travel · No SSN required
        </p>
      </div>
    </section>
  );
