...
export default function NavBar() {
  ...
  return (
    <header className={`sticky top-0 z-[100] -mb-12 w-full px-2.5 py-2 transition-transform duration-300 ease-out sm:px-6 sm:py-3.5 lg:px-8 ${navVisible ? "translate-y-0" : "-translate-y-[calc(100%+1rem)]"}`}>
