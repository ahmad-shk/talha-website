      ...
      <div className="relative z-[1] mx-auto max-w-[1400px]">
        ...
        <div className="grid items-start gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {markets.map((market, index) => {
            ...
            return (
              <Card key={market.slug} variant="interactive" tone="dark" className="group flex min-h-[320px] flex-col justify-between p-7">
                <div>
                ...
                <div className="mt-8">
                  ...
                  >
                    Explore
                    <CaretDown weight="bold" className={`h-4 w-4 transition-transform duration-[var(--fm-motion-component)] ${isOpen ? "rotate-180" : ""}`} />
                  </button>
                    ...
                    <div className="min-h-0 overflow-hidden">
                      <div className="space-y-2 border-t border-[var(--fm-card-divider)] pt-4">
                        {marketServices.map(({ group, services }) => (
                          <div key={group.title}>
                            <p className="mb-2 font-mono text-[9px] font-bold uppercase tracking-[.14em] text-[var(--fm-card-muted)]">{group.title}</p>
